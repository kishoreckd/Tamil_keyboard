...
import 'package:keyboard_tamil/widgets/layout3.dart';
import 'package:keyboard_tamil/widgets/layout2.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon:
                SvgPicture.string(isDarkMode ? feedbackIcon : feedbackFocused),
            color:
