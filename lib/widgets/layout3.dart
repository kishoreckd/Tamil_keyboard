...
class Layout3 extends ConsumerStatefulWidget {
  const Layout3(
      {super.key,
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _Layout3State();
}

class _Layout3State extends ConsumerState<Layout3> {
  late String text;
